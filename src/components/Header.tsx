...
const Header = () => {
  ...
  return <header className="bg-[#5CC8E8] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Left side - Government branding */}
          <div className="flex items-center space-x-4">
            <Link to="/" className="flex items-center">
              <img src="/lovable-uploads/5acabbd1-aa0f-4300-928d-1ddc9d9a9999.png" alt="Australian Government myGov" className="h-24 w-auto font-bold" />
            </Link>
          </div>

          {/* Right side - Navigation and Help */}
          <div className="flex items-center space-x-6">
            {isHomePage && <nav className="hidden md:flex items-center space-x-6">
            ...
            <Button variant="ghost" className="hover:bg-white/20 font-medium underline text-slate-950">
              Help
            </Button>
          </div>
        </div>
