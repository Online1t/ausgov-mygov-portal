...
const SignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate("/enter-code", { state: { username } });
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-12 border-gray-300 focus:border-mygov-blue"
                  disabled={isLoading}
                />
                <Link 
                  to="/forgot-username" 
                  className="text-sm text-mygov-text-secondary hover:underline block"
                >
                  Forgot username
                </Link>
              </div>
              ...
              <Button 
                type="submit"
                className="w-full h-12 bg-mygov-light-blue hover:bg-mygov-light-blue/90 text-white font-medium"
                disabled={isLoading}
              >
              ...
              <div className="text-center">
                <Link 
                  to="/create-account" 
                  className="text-sm text-mygov-text-secondary hover:underline"
                >
